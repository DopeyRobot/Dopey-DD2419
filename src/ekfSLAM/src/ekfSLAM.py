...
class EkfSLAM:
    ...
    def _sendUpdateJumps(self):
        ...
        transform2map = self.buffer.lookup_transform('odom', 'map', self.currHeaderStamp, rospy.Duration(20))
        ...
        #----
        x_jump = self.jumpVec[0]#self.mu_t[0,0]-self.mu_bar_odom_t[0,0]
        # print(x_jump)
        y_jump = self.jumpVec[1]#self.mu_t[1,0]-self.mu_bar_odom_t[1,0]
        yaw_jump = self.jumpVec[2]#self.mu_t[2,0]-self.mu_bar_odom_t[2,0]
