...
class BoundingBoxNode:
    def __init__(self) -> None:
        ...
        self.model_path = "/home/robot/dd2419_ws/src/bounding_box_detection/src/det_2023-02-21_19-29-24-367975.pt"
    ...
    def run(self):
        while not rospy.is_shutdown():
            if self.image is not None:
                ...
                if len(bbs) >0:
                    bbs = utils.non_max_suppresion(bbs, confidence_threshold=0.75, diff_class_thresh=0.6)
